...
open class ContainerViewController: UIViewController, ContainerViewControllerPresenting {
    ...
    open func willPresentViewController(_ controller: UIViewController, animated: Bool) {}
    ...
    open func didPresentViewController(_ controller: UIViewController, animated: Bool) {}
