...
internal struct DecelerationHelper {

    /// - parameter initialVelocity: in points/millisecond
    internal static func project(value: CGFloat, initialVelocity: CGFloat, decelerationRate: CGFloat) -> CGFloat {
    ...
    /// - parameter initialVelocity: in points/millisecond
    internal static func project(value: CGPoint, initialVelocity: CGPoint, decelerationRate: CGPoint) -> CGPoint {
    ...
    /// - parameter initialVelocity: in points/millisecond
    internal static func project(value: CGPoint, initialVelocity: CGPoint, decelerationRate: CGFloat) -> CGPoint {
